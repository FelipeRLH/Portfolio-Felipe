...
function Projects() {
  ...
  const project1 = {
    ...
    description: "A aplicação é um gerenciador de projetos que facilita o trabalho em equipe mostrando de forma pratica os projetos para todo o time. Podemos adicionar, remover e editar projetos. Neste projeto, utilizei amplamente a técnica de componentização do React, que possibilita a criação de componentes reutilizáveis e de fácil manutenção. Além disso, fiz uso da Fetch API com os métodos GET e POST para acessar dados em um banco de dados. Para facilitar o desenvolvimento, utilizei uma biblioteca externa chamada json-server, que permite criar um banco de dados local de forma simples e eficiente.",
  ...
  const project2 = {
    ...
    title: "Movies",
    img: filmestmdb,
    description: "Este é um projeto de Catálogo de filmes desenvolvido utilizando a biblioteca React e a API do TMDB. O projeto conta com uma lista dos melhores filmes e um buscador, que permite pesquisar filmes por nome e visualizar detalhes como orçamento, receita, duração, entre outros. Para obter os dados do site, utilizei a Fetch API para buscar informações diretamente da API do TMDB. Essa técnica proporciona um carregamento rápido dos dados e uma experiência mais fluida para o usuário. Também utilizei React-router para configuração das rotas e React-icons.",
    tecs: ["HTML", "CSS", "JavaScript", "React"],
    links: ["/moreprojects/Filmes-TMDB"]
  }
  const project3 = {
    type: "type1",
    ...
    img: siteportfolio,
    description: "Este é um site portfólio que desenvolvi utilizando React, juntamente com a ferramenta de design Figma. Na criação do site, utilizei diversas funcionalidades do React, como a configuração de rotas com o React Router, permitindo a criação de rotas específicas utilizando o hook useParams. Também realizei requisições à API utilizando o Fetch e realizei o tratamento dos dados provenientes de um arquivo JSON. Para facilitar o desenvolvimento, utilizei bibliotecas externas do npm. Além disso, para estilizar o site, utilizei técnicas de CSS como o Flexbox e o Grid, garantindo uma boa disposição dos elementos na página.",
    tecs: ["HTML", "CSS", "JavaScript", "React", "Figma"],
    links: ["https://github.com/FelipeRLH/Site-Portfolio-Felipe", "https://portfolio-felipe-six.vercel.app/"]
  }
  const project4 = {
    type: "type2",
